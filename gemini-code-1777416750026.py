...
def load_data():
    try:
        ...
        # Limpieza de nombres de columnas (quita espacios y basura)
        df.columns = df.columns.str.strip()
        
        # Seleccionamos solo las columnas necesarias que sabemos que existen
        cols_validas = ['Fecha', 'Tienda', 'Producto', 'Categoria', 'Cantidad', 'Precio_Unitario', 'Total']
        df = df[cols_validas]
        
        # Convertir tipos de datos para que los cálculos no fallen
